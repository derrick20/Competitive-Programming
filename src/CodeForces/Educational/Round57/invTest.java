...
public class invTest {
    ...
    /*
    Fixed: 689532033 Inter: 665838659 Unfixed: 111912694
325113709
     */
    public static void main(String[] args) throws Exception {
        Scanner in = new Scanner(new FileReader("/Users/derrick/IntelliJProjects/src/CodeForces/Round57/InvExp.out"));
    ...
    static void solve(Scanner in, PrintStream out) {
        ...
        out.println("missing = " + missing + " => " + ((missing * missing * (missing - 1)) / 2));
