...
//        }
        ...
        private long queryMinHelper(int node, int l, int r) {
            if (r < lo[node] || hi[node] < l) {
                ...
                pushDown(node);
                long leftResult = queryMinHelper(2 * node, l, r);
                long rightResult = queryMinHelper(2 * node + 1, l, r);
                pullUp(node);
