...
public class SplitTest {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));//new FileReader("split.in"));
        PrintWriter pw = new PrintWriter(System.out);//new BufferedWriter(new FileWriter("split.out")));
